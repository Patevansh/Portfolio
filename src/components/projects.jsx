                            ...
                            <div className="p-8">
                                ...
                                <div className="flex gap-4">
                                    <a
                                        ...
                                        target="_blank"
                                        rel="noopener noreferrer"
                                        className="flex items-center px-6 py-3 bg-gray-800 text-white rounded-xl hover:bg-gray-700 transition-colors duration-200 font-semibold"
                                    >
                                        <span className="mr-2">🐙</span>
                                        View Code
                                    </a>
                                    {selectedProject.liveUrl && (
                                        <a
                                            ...
                                            target="_blank"
                                            rel="noopener noreferrer"
                                            className="flex items-center px-6 py-3 bg-blue-500 text-white rounded-xl hover:bg-blue-600 transition-colors duration-200 font-semibold"
                                        >
                                            <span className="mr-2">🚀</span>
                                            Live Demo
                                        </a>
